...
/emsdk/upstream/emscripten/tools/file_packager.py onlyincludes.data --js-output=onlyincludes.js --preload /emsdk/upstream/emscripten/cache/sysroot/include@include /emsdk/upstream/lib/clang/17/include@clang-17 --lz4 --no-node --from-emcc
