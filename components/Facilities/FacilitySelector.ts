...
const FacilityFactory : Record<string, () => PlaygroundFacility> = {
    "Custom mlir-opt": () => { return new MlirOpt(); },
    "Toy Chapter 1": () => { return new ToyChapter(1); },
    "Toy Chapter 2": () => { return new ToyChapter(2); },
    "Toy Chapter 3": () => { return new ToyChapter(3); },
    "Toy Chapter 4": () => { return new ToyChapter(4); },
    "Toy Chapter 5": () => { return new ToyChapter(5); },
    "Toy Chapter 6": () => { return new ToyChapter(6); },
    "Toy Chapter 7": () => { return new ToyChapter(7); },
};
